<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-2" x-show="! photoPreview">
                    <img src="{{ $this->user->profile_photo_url }}" alt="{{ $this->user->full_name }}" class="object-cover w-20 h-20 rounded-full">
                </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="name" type="text" class="block w-full mt-1" wire:model.defer="state.full_name" autocomplete="name" />
