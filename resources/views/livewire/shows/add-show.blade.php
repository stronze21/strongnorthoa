...
<div class="flex flex-col max-w-6xl px-3 py-5 mx-auto mt-5 bg-white rounded-lg">
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
        <div class="form-control">
            ...
            <label class="">
              <input wire:model.defer="date" type="date" min="{{date('Y-m-d')}}" class="w-full input input-sm input-bordered" />
            </label>
        </div>
        <div class="form-control">
            <label class="label">
            ...
            <label class="">
              <input wire:model.defer="time" type="time" value="{{date('H:i')}}" class="w-full input input-sm input-bordered" />
            </label>
        </div>
        <div class="form-control">
            <label class="label">
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div class="form-control">
            ...
            <label class="">
              <input wire:model.defer="partner" type="text" class="w-full input input-sm input-bordered" />
            </label>
        </div>
        <div class="form-control">
            <label class="label">
            ...
            <label class="">
                <select wire:model.defer="partner_type" class="w-full text-sm select select-sm select-bordered">
                    <option selected></option>
                    <option value="BSP">Bonus Set Program Partner</option>
                    <option value="BKP">Lifechanger's Booking Partner</option>
                    <option value="BKG">Booking Gift for Client</option>
                </select>
            </label>
        </div>
        <div class="form-control">
    ...
    <div class="grid grid-cols-1 gap-4">
        <div class="form-control">
            ...
            <label class="">
                <select wire:model.defer="sspl" class="w-full select select-bordered">
    ...
    <div class="grid grid-cols-1 gap-4">
        <div class="form-control">
            <label class="label">
              <span class="label-text">Why do you think this host WILL invest?<span class="text-error">*</span></span>
            </label>
            <label class="">
                <textarea wire:model.defer="reason1" class="w-full rounded-lg"></textarea>
            </label>
        </div>
    </div>
    <div class="grid grid-cols-1 gap-4">
        <div class="form-control">
            <label class="label">
              <span class="label-text">Why do you think this host will NOT invest?<span class="text-error">*</span></span>
            </label>
            <label class="">
                <textarea wire:model.defer="reason2" class="w-full rounded-lg"></textarea>
            </label>
        </div>
    </div>
