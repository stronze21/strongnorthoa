<div class="container-fluid">
            ...
            <div class="table">
                <table class="table table-sm table-hover table-bordered table-striped" style="font-size: 12px;">
                    ...
                    <tbody class="text-uppercase">
                        @foreach ($data as $row)
                        <tr class="{{$selected_cs == $row ? 'table-primary' : ''}}" wire:click="show_cs({{$row->cs_id}})" data-bs-toggle="modal" data-bs-target="#newContest">
                            <td>{{$row->type}}</td>
    ...
    <!-- Modal -->
    <div class="modal fade" id="newContest" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="newContestLabel" aria-hidden="true" wire:ignore.self>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-3">
                ...
                <div class="form-group bg-light p-3">
                    ...
                    <select id="contest_id" class="form-select form-select-sm me-1" wire:model.defer="contest_id">
            ...
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" wire:click="hide_cs()">Close</button>
