            ...
            <div class="grid grid-cols-1 px-3 py-5 md:grid-cols-2">
                <div class="flex flex-col col-span-2 mx-5">
                    ...
                    <table class="table w-full table-zebra table-compact">
                        ...
                        <tr class="uppercase border">
                            <th>Partner:</th>
                            <td>{{ $show->partner_id ? $show->partner_user->fullname() : '' }}</td>
                        </tr>
                        <tr class="uppercase border">
                            <th>Partner Type:</th>
                        ...
                        <table class="table w-full table-compact">
                            ...
                            <tbody>
                                @foreach ($show->results->all() as $result)
                                    ...
                                    <tr>
                                        <th colspan="2" class="text-center border active">
                                            ----------------------------------------------------------------------------------------------------
                                        </th>
                                    </tr>
                                @endforeach
                ...
                <table class="table w-full table-compact">
                    ...
                    <tbody class="border">
                        @foreach ($show->order_agreements as $order)
                            <tr wire:key="view-oa-{{ $order->id }}" wire:click="view_oa({{ $order->id }})"
                            ...
                            <tr class="border-b">
                                <td colspan="2" class="text-right uppercase"><span> Amount:
                                        {{ $order->items->sum('item_total') }}</span></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="modal-box">
            ...
            <div class="w-full py-4">
                ...
                @else
                    <div class="w-full mb-2 form-control">
                        ...
                        <input type="number" step="0.01" class="w-full select-bordered select"
            ...
            <div class="modal-action">
                ...
                <button class="btn btn-primary" wire:loading.attr="disabled"
                    wire:click="update_result">Submit</button>
            </div>
        </div>
    </div>
</div>
