...
<div class="flex flex-col mx-auto space-x-0 max-w-screen-2xl">
    <div class="flex flex-col w-full px-3 py-5 mx-auto mt-5 bg-white rounded-lg">
        ...
        <div class="flex justify-between w-full mt-4">
            ...
            <button class="mr-2 btn btn-error" wire:click="reset_password()"
                @if (!$user_id) disabled @endif>Reset Password</button>
    ...
    <div class="flex flex-col w-full px-3 py-5 mx-auto mt-5 bg-white rounded-lg">
        ...
        <div class="flex justify-end mt-4">
            <button class="btn btn-primary" wire:click="add_dependent()"
                @if (!$user_id) disabled @endif>Save</button>
        </div>
    </div>
    <div class="flex flex-col w-full px-3 py-5 mx-auto mt-5 bg-white rounded-lg">
        ...
        <div class="flex justify-end mt-4">
            <button class="btn btn-primary" wire:click="add_experience()"
                @if (!$user_id) disabled @endif>Save</button>
        </div>
    </div>
    <div class="flex flex-col w-full px-3 py-5 mx-auto mt-5 bg-white rounded-lg">
        ...
        <div class="flex justify-end mt-4">
            <button class="btn btn-primary" wire:click="add_reference()"
                @if (!$user_id) disabled @endif>Save</button>
        </div>
    </div>
    <div class="flex flex-col w-full px-3 py-5 mx-auto mt-5 bg-white rounded-lg">
        ...
        <div class="flex justify-end mt-4">
            <button class="btn btn-primary" wire:click="save_profile()"
                @if (!$user_id) disabled @endif>Save</button>
        </div>
        ...
        <div class="flex justify-end mt-4">
            <button class="btn btn-primary" wire:click="add_promotion()"
                @if (!$user_id) disabled @endif>Save</button>
        </div>
