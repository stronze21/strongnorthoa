...
class CreateOrderAgreementItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('order_agreement_items', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('order_agreement_items');
    }
}
